...
package com.hurlant.crypto.cert {
	...
	public class X509Certificate {
		...
		public function getSubjectPrincipal():String {
			load();
			base64Encoder.encodeBytes(_obj.signedCertificate.subject_bin);
		...
		public function getIssuerPrincipal():String {
			load();
			base64Encoder.encodeBytes(_obj.signedCertificate.issuer_bin);

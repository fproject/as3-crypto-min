...
package com.hurlant.crypto
{
	...
	public class Crypto
	{
		...
		private static const nameToClass:Object = {};
		
		/**
		 * 
		 * @param nameOrClass Hash name or class name of the implementation of IHash
		 * Things that should work:
		 * "md5" or com.hurlant.crypto.hash.MD5
		 * "sha" or com.hurlant.crypto.hash.SHA
		 * "sha1" or com.hurlant.crypto.hash.SHA1
		 * "sha224" or com.hurlant.crypto.hash.SHA224
		 * "sha256" or com.hurlant.crypto.hash.SHA256
		 * 
		 */
		public static function getHash(nameOrClass:*):IHash {
			if(nameOrClass is Class)
				var hashClass:Class = nameOrClass as Class;
			else
			{
				if(nameToClass[nameOrClass] == undefined)
					nameToClass[nameOrClass] = getDefinitionByName("com.hurlant.crypto.hash." + nameOrClass);
				hashClass = nameToClass[nameOrClass];
			}
